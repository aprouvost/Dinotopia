public class Carnivore extends Dinosaure { // Herbivore est une classe fille. Dinosaure est la classe mère.
      ...
      public Carnivore ( double propViandeNecessaire){
        super("Carnivore", 0.7, 0.4); // On indique que c'est un Dinosaure de type herbivore en utilisant le contructeur de la classe mère
        this.propViandeNecessaire= propViandeNecessaire;
      }
