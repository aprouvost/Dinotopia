...
public class PanStats extends JPanel implements ActionListener {
	...
	public PanStats(Plateau plateau) { //CONSTRUCTEUR
		...
		this.prctgDino = new JLabel("<html>Pourcentage de dinosaures :<br>"+plateau.prop*100+"%</html>");
		this.prctgDino.setFont(policeStats);

		this.prctgVegetaux = new JLabel("<html>Pourcentage de vegetaux :<br>"+(1.0-plateau.prop*100+"%</html>");
